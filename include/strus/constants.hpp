...
struct Constants
{
	...
	///\brief List of default characters interpreted as quotes to strip away at the beginning or the end of a word
	static inline const char* stripQuoteCharacters()
	{
		return "\"'’`;.:―—–‒‑‐•‥…‣․";
		/*
		TABLE of dashes declared as quote characters in this string returned:
		‐	8208	2010	 	HYPHEN

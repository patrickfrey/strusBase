...
namespace strus
{
	...
	enum ErrorCode
	{
		...
		ErrorCodeLoadModuleFailed=236,
		ErrorCodeNotImplemented=237,
		ErrorCodeIncompleteInitialization=238,
		ErrorCodeIncompleteDefinition=239,
		ErrorCodeIncompleteConfiguration=240,

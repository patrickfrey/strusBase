...
///\brief We need this function because we want to print error messages in an exception context without using malloc because we might not have memory available anymore (std::bad_alloc)

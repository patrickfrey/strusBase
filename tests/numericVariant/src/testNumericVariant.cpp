...
int main( int argc, const char* argv[])
{
	...
	try
	{
		...
		errcnt += (int)!testToString<uint64_t>( ++testidx, 1ULL << 32);
		errcnt += (int)!testToString<int64_t>( ++testidx, 1ULL << 62);
		errcnt += (int)!testToString<uint64_t>( ++testidx, 1ULL << 62);
		errcnt += (int)!testToString<int64_t>( ++testidx, +99170709832174L);
		errcnt += (int)!testToString<uint64_t>( ++testidx, +99170709832174L);
